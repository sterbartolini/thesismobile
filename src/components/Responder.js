    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                <TouchableOpacity style={{ top: screen.height - 235, left: screen.width - 380 }} onPress={this._toggleModal}>
                    <Image
                ...
                {this.state.isIncidentReady === true ? (
                        <TouchableOpacity style={{ top: screen.height - 650, left: screen.width - 100 }} onPress={this.requestAdditionalVolunteers}>
                        <Image
                            style={{ width: 70, height: 70 }}
                ...
                {this.state.isIncidentReady === true ? (
                        <TouchableOpacity style={{ top: screen.height - 550, left: screen.width - 100 }} onPress={this.requestAdditionalResponders}>
                        <Image
                            style={{ width: 70, height: 70 }}
                ...
                {this.state.isIncidentReady === true  && this.state.originalResponder === true ? (
                    <TouchableOpacity style={{ top: screen.height - 450, left: screen.width - 100 }} onPress={this.arrivedLocation}>
                        <Image
                            style={{ width: 70, height: 70 }}
